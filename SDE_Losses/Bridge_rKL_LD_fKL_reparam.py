...
class Bridge_fKL_reparam_Loss_Class(Base_SDE_Loss_Class):
    ...
    def evaluate_loss(self, params, Energy_params, SDE_params, SDE_tracer, key, temp = 1.0):
        ...
        if self.SDE_type.config['use_off_policy']:  
            ...
            loss, L1, L2 = self.compute_fKL_reparam(SDE_params, log_prior, reverse_log_probs, forward_diff_log_probs, entropy_minus_noise,Energy, temp, 
    ...
    def compute_fKL_reparam(self, SDE_params, log_prior, reverse_log_probs, forward_diff_log_probs, entropy_minus_noise,Energy, temp, off_policy_weights = 1., use_off_policy = False):
