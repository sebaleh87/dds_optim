...
# Base configuration
base_config="--SDE_Loss Bridge_rKL_logderiv --Energy_Config Funnel --n_integration_steps 128 --T_start 1.0 --T_end 1. --batch_size 2000 --Energy_lr 0.0 --N_anneal 6000 --feature_dim 64 --n_hidden 64 --GPU 6 --beta_min 0.01 --use_interpol_gradient --Network_Type FeedForward --project_name FeedForward --use_normal --SDE_Type Bridge_SDE --repulsion_strength 0.0 --n_particles 10"
